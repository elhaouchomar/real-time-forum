...
function createLikeCounter(post) {
  ...
  likeCounter.innerHTML = `<i class="material-symbols-outlined popup-icon" id="${post.post_id}">thumb_up</i><span id="${post.post_id}">${post.like_count}</span>`;
  return likeCounter;
}
...
function createDislikeCounter(post) {
  ...
  dislikeCounter.innerHTML = `<i class="material-symbols-outlined popup-icon" id="${post.post_id}">thumb_down</i><span id="${post.post_id}">${post.dislike_count}</span>`;
